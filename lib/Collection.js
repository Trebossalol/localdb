...
var Collection = /** @class */ (function () {
    function Collection(name, config) {
        ...
        if (config.singleInstance === true)
            this._updateStoragePath();
    }
    Collection.prototype._updateStoragePath = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fs_1.writeFileSync(storagePath, this._getJson([]));
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(this.config.onRestartBehaviour === 'OVERWRITE')) return [3 /*break*/, 4];
                        return [4 /*yield*/, Util_1.writeFile(storagePath, this._getJson([]))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    Collection.prototype._getJson = function (data) {
